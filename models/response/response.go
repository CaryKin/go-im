...
func Json(c *gin.Context, data interface{}, code int, msg string) {
...
func Success(c *gin.Context) {
	Json(c, map[string]interface{}{}, code.Success, "Success")
}

func SuccessData(c *gin.Context, data interface{}) {
	Json(c, data, code.Success, "Success")
}

func ErrorMessage(c *gin.Context, errCode int, message string) {
	Json(c, map[string]interface{}{}, errCode, message)
}

func Error(c *gin.Context, errCode int) {
	message := code.GetErrorMessage(errCode, "")
	Json(c, map[string]interface{}{}, errCode, message)
}
